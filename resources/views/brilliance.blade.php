    ...
    <div class="container-fluid">
          ...
          <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
                ...
                <div class="collapse navbar-collapse" id="ftco-nav">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item active"><a href="/" class="nav-link pl-0"><b> 𝐻𝑜𝓂𝑒</b></a></li>
                        <li class="nav-item active"><a href="course" class="nav-link pl-0"><b>𝒞𝑜𝓊𝓇𝓈𝑒𝓈 </b></a></li>
                        <li class="nav-item active">
                            <a href="events" class="nav-link"> <b>𝐸𝓋𝑒𝓃𝓉𝓈</b></a>
                        </li>
                        <li class="nav-item active">
                            <a href="news" class="nav-link"> <b>𝒩𝑒𝓌𝓈</b></a>
                        </li>
        ...
        <div class="row">
            <div class="col-lg-3 col-sm-12 col-xs-12 col-md-12" style="height: 300px; background-color: rgb(121, 186, 247);">
                ...
                <p class="staffdiv" style="text-align: justify;">Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio nesciunt ea autem suscipit in explicabo repudiandae provident, omnis ratione fugiat, praesentium ipsum. Facere itaque odit quos? Cum tempora unde perferendis.</p>
            ...
            <div class="col-lg-3 col-sm-12 col-xs-12 col-md-12" style="height: 300px; background-color: rgb(143, 153, 155);">
                ...
                <p class="staffdiv" style="text-align: justify;">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ex optio animi, corporis accusantium voluptatum possimus eveniet ducimus autem laboriosam expedita eligendi dolore atque rem reprehenderit voluptates velit omnis nihil soluta.</p>
            </div>
            <div class="col-lg-3 col-sm-12 col-xs-12 col-md-12" style="height: 300px; background-color: rgb(121, 186, 247);">
                ...
                <p class="staffdiv" style="text-align: justify;">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Non maiores autem possimus debitis dicta voluptatum sapiente excepturi blanditiis corrupti voluptatibus, voluptas id, aliquam obcaecati aperiam optio eaque, itaque quos exercitationem.</p>
            </div>
            <div class="col-lg-3 col-sm-12 col-xs-12 col-md-12" style="height: 300px; background-color: rgb(143, 153, 155);">
                ...
                <p class="staffdiv" style="text-align: justify;">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Hic quasi natus nulla! Dolores magnam veritatis cum dolorem consequuntur provident officiis dicta ipsam quas, voluptatem voluptate nisi asperiores aspernatur quo beatae!</p>
            </div>
        </div>
        ...
        <footer>
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-12 col-xs-12 col-md-12" style="height: 200px; background-color: rgb(68, 62, 62); align-content: center;">
                    <h4  class="footlinks" style="color: white;">Links</h4><br>
                ...
                <div class="col-lg-4 col-sm-12 col-xs-12 col-md-12" style="height: 200px; background-color: rgb(68, 62, 62);">
                    <h4 class="footlinks" style="color: white;margin-left: 50px;">Connect With Us</h4><br>&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <div class="col-lg-4 col-sm-12 col-xs-12 col-md-12" style="height: 200px; background-color: rgb(68, 62, 62);">
                    <h4 class="footlinks" style="color: white;  margin-left: 70px;">Contact Us</h4><br>
