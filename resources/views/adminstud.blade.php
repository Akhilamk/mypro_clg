...
<div class="card-group" style="padding: 30px;">
    <div class="card">
        <img src="{{url('images/comp.png')}}" class="card-img-top" alt="...">
        <div class="card-body">
    ...
    <div class="card">
        <img src="{{url('images/img1.jpg')}}" class="card-img-top" alt="...">
        <div class="card-body">
    ...
    <div class="card">
        <img src="{{url('images/hat.png')}}" class="card-img-top" alt="..." style="height: 210px;">
        <div class="card-body">
    ...
    <div class="card">
        <img src="{{url('images/img3.jpg')}}" class="card-img-top" alt="..." style="height: 210px;">
        <div class="card-body">
